...
# Generated by qmake (2.01a) (Qt 4.7.4) on: ?? ?? 30 13:43:40 2012
...
INCPATH       = -I../../../QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/share/qt4/mkspecs/default -I. -I../../../QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/include/qt4/QtCore -I../../../QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/include/qt4/QtGui -I../../../QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/include/qt4/QtSql -I../../../QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/include/qt4/QtDeclarative -I../../../QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/include/qt4 -Iqmlapplicationviewer -Imoc
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -LD:/QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/lib -pie -rdynamic -lmdeclarativecache -lQtDeclarative -lQtSql -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/TrainTimetables1.0.0/ && $(COPY_FILE) --parents qmlapplicationviewer/qmlapplicationviewer.h trainsinfo.h obj/TrainTimetables1.0.0/ && $(COPY_FILE) --parents main.cpp trainsinfo.cpp qmlapplicationviewer/qmlapplicationviewer.cpp obj/TrainTimetables1.0.0/ && (cd `dirname obj/TrainTimetables1.0.0` && $(TAR) TrainTimetables1.0.0.tar TrainTimetables1.0.0 && $(COMPRESS) TrainTimetables1.0.0.tar) && $(MOVE) `dirname obj/TrainTimetables1.0.0`/TrainTimetables1.0.0.tar.gz . && $(DEL_FILE) -r obj/TrainTimetables1.0.0
...
compiler_moc_header_make_all: moc/moc_qmlapplicationviewer.cpp moc/moc_trainsinfo.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc/moc_qmlapplicationviewer.cpp moc/moc_trainsinfo.cpp
...
install_db: first FORCE
	@$(CHK_DIR_EXISTS) $(INSTALL_ROOT)/opt/TrainTimetables/data/ || $(MKDIR) $(INSTALL_ROOT)/opt/TrainTimetables/data/ 
	-$(INSTALL_FILE) d:/studio/Github/TrainTimetables/trains.db $(INSTALL_ROOT)/opt/TrainTimetables/data/


uninstall_db:  FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/opt/TrainTimetables/data/trains.db
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/TrainTimetables/data/ 
