...
# Generated by qmake (2.01a) (Qt 4.7.4) on: ?? ?? 27 11:49:14 2012
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/TrainTimetables1.0.0/ && $(COPY_FILE) --parents qmlapplicationviewer/qmlapplicationviewer.h trainsinfo.h update.h settings.h macro.h obj/TrainTimetables1.0.0/ && $(COPY_FILE) --parents main.cpp trainsinfo.cpp update.cpp settings.cpp qmlapplicationviewer/qmlapplicationviewer.cpp obj/TrainTimetables1.0.0/ && (cd `dirname obj/TrainTimetables1.0.0` && $(TAR) TrainTimetables1.0.0.tar TrainTimetables1.0.0 && $(COMPRESS) TrainTimetables1.0.0.tar) && $(MOVE) `dirname obj/TrainTimetables1.0.0`/TrainTimetables1.0.0.tar.gz . && $(DEL_FILE) -r obj/TrainTimetables1.0.0
