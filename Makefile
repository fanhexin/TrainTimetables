...
# Generated by qmake (2.01a) (Qt 4.7.4) on: ?? ?? 26 21:15:49 2013
...
install_itemfolder_01: first FORCE
	...
	-$(INSTALL_DIR) d:/studio/harmattan/TrainTimetables/qml/TrainTimetables $(INSTALL_ROOT)/opt/TrainTimetables/qml/
...
install_icon: first FORCE
	...
	-$(INSTALL_FILE) d:/studio/harmattan/TrainTimetables/TrainTimetables80.png $(INSTALL_ROOT)/usr/share/icons/hicolor/80x80/apps/
...
install_desktopfile: first FORCE
	...
	-$(INSTALL_FILE) d:/studio/harmattan/TrainTimetables/TrainTimetables_harmattan.desktop $(INSTALL_ROOT)/usr/share/applications/
...
install_db: first FORCE
	...
	-$(INSTALL_FILE) d:/studio/harmattan/TrainTimetables/trains.db $(INSTALL_ROOT)/opt/TrainTimetables/db/
